...
export const CURRICULUM: UnitEntry[] = [
  {
    ...
    lessons: [
      { slug: 'u1-l1', unit: 1, lessonNumber: 1, title: 'The Cost of Sitting Out',         type: 'briefing',           status: 'published' },
      { slug: 'u1-l2', unit: 1, lessonNumber: 2, title: 'The Six Tensions of American Politics', type: 'briefing',     status: 'published' },
      { slug: 'u1-l3', unit: 1, lessonNumber: 3, title: 'Empirical vs. Normative',         type: 'briefing',           status: 'published' },
      { slug: 'u1-l4', unit: 1, lessonNumber: 4, title: 'Spotting your Own Bias',          type: 'artifact_analysis',  status: 'published' },
      { slug: 'u1-l5', unit: 1, lessonNumber: 5, title: 'Steelmanning Practice',           type: 'deliberation',       status: 'published' },
      { slug: 'u1-l6', unit: 1, lessonNumber: 6, title: 'Tradeoff Question',               type: 'deliberation',       status: 'published' },
      { slug: 'u1-l7', unit: 1, lessonNumber: 7, title: 'Reflection Sharing',              type: 'reflection_sharing', status: 'published' },
    ],
  },
  {
    unit: 2,
